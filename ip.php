...
<link rel="stylesheet" type="text/css" href="https://ir.zarinpal.com/themed/Zarinpal/css/style.css2" />
<style type="text/css">
...
<fieldset>
		...
		<form name="form1" method="POST">
			...
			<input type="text" value="2000" name="price" class="input-eng" style="width:120px;!important;direction:ltr;">
    ...
    try {
        ...
        switch ($result->Status) {
            ...
            case "-2":
                ...
                break;
            case "-3":
                $ERR = "حداقل میبغ قابل پرداخت 100 تومان می باشد";
                break;
            case "-4":
        ...
        if ($result->Status == 100) {
            ...
            echo "<div id=\"flashMessage\" class=\"error-msg \"> کد خطا  : " . $result->Status . " </br>
		علت خطا : " . $ERR . "
		</div>";
